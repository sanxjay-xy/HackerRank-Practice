...
- Standard input/output unless problem requires otherwise  
- Only standard Java libraries used – no shortcuts  

---

## ⚔️ Problem Tags Covered
...
- ✅ Dynamic Programming  
- ✅ OOP Design Patterns (when applicable)
...
- 🚫 No copy-paste  
- 🔍 Read, Understand, Solve from scratch  
- 💡 Focus on clean logic, optimal solutions, and readability  
- 🧪 Tested with sample + edge cases  
...
> 🧠 _“Consistency beats intensity.”_ – This repo is proof of that mindset.
